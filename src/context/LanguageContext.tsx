...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'error.loadConfigFailed': 'Failed to load configuration',
    'error.featureNotSupported': 'This feature is not supported by the device',
    ...
    'config.time': 'Device Time',
    'config.timezone': 'Timezone',
    'config.datetime': 'Date & Time',
    'config.syncTime': 'Sync with System',
    'config.image': 'Image Settings',
    'config.flip': 'Image Flip',
    'config.flip.on': 'Enabled',
    'config.flip.off': 'Disabled',
    'config.audio': 'Audio & Video',
    'config.volume.talk': 'Speaker Volume',
    'config.volume.prompt': 'Prompt Volume',
    'config.fps': 'FPS Mode',
    'config.fps.low': 'Low',
    'config.fps.normal': 'Normal',
    'config.fps.high': 'High',
    'config.fps.super': 'Super',
    'config.network': 'Network Settings',
    'config.dhcp': 'DHCP',
    'config.ip': 'IP Address',
    'config.mask': 'Subnet Mask',
    'config.gateway': 'Gateway',
    'config.dns': 'DNS',
    'config.alarm': 'Alarm & Detection',
    'config.motion': 'Motion Detection',
    'config.motion.sensitivity': 'Sensitivity',
    'config.record': 'Recording Schedule',
    'config.record.mode': 'Recording Mode',
    'config.week.sun': 'Sun',
    'config.week.mon': 'Mon',
    'config.week.tue': 'Tue',
    'config.week.wed': 'Wed',
  ...
  zh: {
    ...
    'error.featureNotSupported': '设备不支持此功能',
    ...
    'config.time': '设备时间',
    'config.timezone': '时区',
    'config.datetime': '日期和时间',
    'config.syncTime': '同步系统时间',
    'config.image': '图像设置',
    'config.flip': '图像翻转',
    'config.flip.on': '已开启',
    'config.flip.off': '已关闭',
    'config.audio': '音视频设置',
    'config.volume.talk': '扬声器音量',
    'config.volume.prompt': '提示音音量',
    'config.fps': '帧率模式',
    'config.fps.low': '低',
    'config.fps.normal': '正常',
    'config.fps.high': '高',
    'config.fps.super': '超级',
    'config.network': '网络设置',
    'config.dhcp': 'DHCP',
    ...
    'config.alarm': '报警与侦测',
    'config.motion': '移动侦测',
    'config.motion.sensitivity': '灵敏度',
    'config.record': '录像计划',
    'config.record.mode': '录像模式',
    'config.week.sun': '周日',
    'config.week.mon': '周一',
    'config.week.tue': '周二',
    'config.week.wed': '周三',
